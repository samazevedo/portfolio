...
export default function Hero() {
	...
	return (
		<section className="relative w-[100vw] h-[100vh]">
			...
			<div className="grid grid-rows-[1fr_0.5fr_1fr] place-items-center gap-5 pt-80 text-center">
				<h1 className="text-6xl  font-bold text-opacity-90 drop-shadow-xl">
				...
				<div className="text-center space-y-4 max-w-2xl px-4 md:px-6 place-self-center mt-1">
					<p className="text-lg sm:text-md md:text-xl font-thin ">Front End Web Developer | Designer</p>
				</div>
